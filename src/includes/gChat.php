...
$redis->cmd('HSET', Director::$mysqlConfig['db'] . ':userNames', $me->id, $me->name)->set();
...
$redis->cmd('HSET', Director::$mysqlConfig['db'] . ':usersLastSeen', $me->id, substr(microtime(true) * 1000, 0, 13))->set();
...
switch ($_SERVER['REQUEST_URI']) {
    case '/edit/chat/listen':
        require $editor->dir . 'src/includes/gChatListener.php';
        break;

    case '/edit/chat/publish':
        require $editor->dir . 'src/includes/gChatPublisher.php';
        break;
